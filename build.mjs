...
const campaign={gym:{word:'BUILD.',line:'One more rep. One more reason.',image:'goal-training.jpg'},sports:{word:'PLAY.',line:'For every game. For every goal.',image:'goal-sports.png'},daily:{word:'EVERY<br>DAY.',line:'Good choices become good habits.',image:'goal-bowl.jpg'},gain:{word:'GROW.',line:'Stay consistent. Keep showing up.',image:'goal-strength.jpg'},recovery:{word:'RESET.',line:'Make the next session count.',image:'goal-recovery.jpg'}};
